...
29 页主线自学 PPT 按优化后的 Markdown 讲义重新组织，教师实验与 imagegen 方法示意分别标注。《阅读讲义》Word 已同步最新主线，实践操作手册 Word 保持原版。原生并行仍需要本人实际子任务活动，不能用上述顺序实验代替。
