...
Word 下载：[阅读讲义](L07-阅读讲义.docx)、[实践操作手册](L07-实践操作手册.docx)。图片已嵌入，可用于导入飞书。

先读[阅读讲义](阅读讲义.md)，理解触发时点、协议、重入与信任，再按[实践操作手册](实践操作手册.md)完成实验和自己的候选。课堂执行可用[行动卡](行动卡.md)，分阶段委托见[提示词](prompts/README.md)，交接使用[提交模板](SUBMISSION.md)。
